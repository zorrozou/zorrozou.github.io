...
![image-20200413111445333](./xfs/1.png)
...
<img src="./xfs/2.png" alt="image-20200413113534883" style="zoom:50%;" />
...
<img src="./xfs/3.png" alt="image-20200413113852722" style="zoom:50%;" />
...
<img src="./xfs/4.png" alt="image-20200413113941141" style="zoom:50%;" />

如果文件内容更多，则需要多级索引。此时会引入中间节点block结构。此时其结构就是叶子节点的xfs_btree_block的头部加上根节点xfs_bmbt_key_t和xfs_bmbt_ptr_t的组合。结构如下：

<img src="./xfs/5.png" alt="image-20200413114026483" style="zoom:50%;" />

xfs多级树结构整体索引示意图：

![image-20200413114056513](./xfs/6.png)
